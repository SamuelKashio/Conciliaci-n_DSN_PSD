...
def cargar_excel_bcp(archivo):
    ...
    df['Fecha de pago'] = df['Fecha operación'].dt.strftime('%d/%m/%Y')
    ...
    return df_filtrado[['PSP_TIN', 'Nº operación', 'Monto', 'Fecha de pago']]
